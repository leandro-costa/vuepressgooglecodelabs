...
<Step label="História" duration="2" >
...
<Step label="Máquina Virtual" duration="10" >
...
<Step label="Java lento? Hotspot e JIT" duration="8" >
...
<Step label="Versões do Java e a confusão do Java2" duration="6" >
...
<Step label="JVM? JRE? JDK? O que devo baixar?" duration="" >
